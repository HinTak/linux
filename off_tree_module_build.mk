...
export ARCH=arm
TOOLCHAINDIR=$(shell which $(CROSS_COMPILE)gcc | egrep -o -e '/.*/' )
...
EXTRACTED_KERNEL_CFLAGS+=-I$(KDIR)/kernel/t2ddebugd/include

CPP_CFLAGS=-nostartfiles -nodefaultlibs -nostdlib -fpermissive -fno-rtti -fno-exceptions -nostdinc++
