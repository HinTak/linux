...
size_t ZSTD_resetCCtx_advanced(ZSTD_CCtx *zc, const ZSTD_parameters *params, U64 frameContentSize, ZSTD_compResetPolicy_e const crp)
{
...
void ZSTD_reduceIndex(ZSTD_CCtx *zc, const U32 reducerValue)
{
	{
...
size_t ZSTD_writeFrameHeader(void *dst, size_t dstCapacity, const ZSTD_parameters *params, U64 pledgedSrcSize, U32 dictID)
{
...
#else
	U64 const rSize = PAGE_SIZE + dictSize ? PAGE_SIZE + dictSize + addedSize : PAGE_SIZE; // Page Size
#endif
