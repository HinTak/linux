                                                 ...
                                                 struct nlattr* envDataAttr )
{
    ...
    switch ( envHeader->type )
    {
        ...
        case SF_ENVIRONMENT_TYPE_SND_RCV:
        {
            SfSndRcvEnvironment* pSndRcvEnv = NULL;
            pPrtclHdr = SF_CREATE_ENVIRONMENT( SfSndRcvEnvironment, SF_ENVIRONMENT_TYPE_SND_RCV );
            pSndRcvEnv = (SfSndRcvEnvironment*)pPrtclHdr;
