...
extern Char* SFAPI SfdConstructAbsoluteFileNameByPath(struct path* const pPath, Char** const ppName);

extern Char* SfdConstructAbsoluteFileNameByFile(struct file* const pFile, Char** const ppName);

extern Char* SFAPI SfdConstructAbsoluteFileNameByTask(const struct task_struct* const pProcessContext,
    Char** const ppName);
                                             ...
                                             Int32 result )
{
    ...
    pEnvironment->pBuffer = (Char *)SfdConstructAbsoluteFileNameByTask( pProcessContext,
                                        ...
                                        const SfOperationFileOpen* pArgs )
{
    ...
    pEnvironment->inode = pArgs->pFile->f_path.dentry->d_inode->i_ino;
    pEnvironment->pBuffer = (Char *)SfdConstructAbsoluteFileNameByFile( pArgs->pFile,
                                           ...
                                           const SfOperationBprmCheckSecurity* pArgs )
{
    ...
    pEnvironment->processImageId = pFile->f_path.dentry->d_inode->i_ino;
    pEnvironment->pBuffer = (Char *)SfdConstructAbsoluteFileNameByFile( pFile, &pEnvironment->pProcessName );
    return ( pEnvironment->pBuffer ) ? SF_STATUS_OK : SF_STATUS_FAIL;
}
                                        ...
                                        const SfOperationFileMmap* pArgs )
{
    ...
    pFile = pArgs->pFile;
    pEnvironment->inode = pFile->f_path.dentry->d_inode->i_ino;
    pEnvironment->pBuffer = (Char *)SfdConstructAbsoluteFileNameByFile( pFile, &pEnvironment->pLibraryName );
    return ( pEnvironment->pBuffer ) ? SF_STATUS_OK : SF_STATUS_FAIL;
}
