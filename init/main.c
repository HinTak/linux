...
#ifdef CONFIG_VD_DEFAULT_LOGLEVEL
	pr_warning("Kernel command line: %s\n", boot_command_line); // under vd loglevel policy, debug version print this but others do not print
#else
