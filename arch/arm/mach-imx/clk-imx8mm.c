...
static const char *imx8mm_qspi_sels[] = {"osc_24m", "sys1_pll_400m", "sys_pll1_800m", "sys2_pll_500m",
					 "audio_pll2_out", "sys1_pll_266m", "sys3_pll2_out", "sys_pll1_100m", };
...
static const char *imx8mm_gpt2_sels[] = {"osc_24m", "sys_pll2_100m", "sys_pll1_400m", "sys_pll1_40m",
					 "video_pll1_out", "sys_pll1_800m", "audio_pll1_out", "clk_ext2" };

static const char *imx8mm_gpt3_sels[] = {"osc_24m", "sys_pll2_100m", "sys_pll1_400m", "sys_pll1_40m",
					 "video_pll1_out", "sys_pll1_800m", "audio_pll1_out", "clk_ext3" };
...
static void __init imx8mm_clocks_init(struct device_node *ccm_node)
{
	...
	clks[IMX8MM_CLK_AHB_DIV] = imx_clk_divider_flags("ahb_div", "ahb_pre_div", base + 0x9000, 0, 6, CLK_SET_RATE_PARENT);
	...
	clks[IMX8MM_CLK_GPT2_SRC] = imx_clk_mux2("gpt2_src", base + 0xb600, 24, 3, imx8mm_gpt2_sels, ARRAY_SIZE(imx8mm_gpt2_sels));
	clks[IMX8MM_CLK_GPT3_SRC] = imx_clk_mux2("gpt3_src", base + 0xb680, 24, 3, imx8mm_gpt3_sels, ARRAY_SIZE(imx8mm_gpt3_sels));
	...
	clks[IMX8MM_CLK_GPT2_CG] = imx_clk_gate3("gpt2_cg", "gpt2_src", base + 0xb600, 28);
	clks[IMX8MM_CLK_GPT3_CG] = imx_clk_gate3("gpt3_cg", "gpt3_src", base + 0xb680, 28);
	...
	clks[IMX8MM_CLK_GPT2_PRE_DIV] = imx_clk_divider2("gpt2_pre_div", "gpt2_cg", base + 0xb600, 16, 3);
	clks[IMX8MM_CLK_GPT3_PRE_DIV] = imx_clk_divider2("gpt3_pre_div", "gpt3_cg", base + 0xb680, 16, 3);
	...
	clks[IMX8MM_CLK_GPT2_DIV] = imx_clk_divider2("gpt2_div", "gpt2_pre_div", base + 0xb600, 0, 6);
	clks[IMX8MM_CLK_GPT3_DIV] = imx_clk_divider2("gpt3_div", "gpt3_pre_div", base + 0xb680, 0, 6);
	...
	clks[IMX8MM_CLK_GPT2_ROOT] = imx_clk_gate4("gpt2_root_clk", "gpt2_div", base + 0x4110, 0);
	clks[IMX8MM_CLK_GPT3_ROOT] = imx_clk_gate4("gpt3_root_clk", "gpt3_div", base + 0x4120, 0);
