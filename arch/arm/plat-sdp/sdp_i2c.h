 ...
 * Feb,08,2013  ij.jang		use common clk api.
 ********************************************************************************************/
...
#elif defined(CONFIG_ARCH_SDP1302) //Golf S
extern unsigned long sdp1302_get_clock (char mode);
#define BUS_SRC_CLK (sdp1302_get_clock (REQ_PCLK)/ 1000)
#define I2C_SRC_CLK	(BUS_SRC_CLK) // unit is Khz, 1500000 Khz 
#define I2C_IRQ 		IRQ_SPI(54)
#define N_I2C_PORT	8
#define I2C_SDA_SKEW	1  	

#elif defined(CONFIG_ARCH_SDP1304) //Golf AP
extern unsigned long sdp1304_get_clock (char mode);
#define BUS_SRC_CLK (sdp1304_get_clock (REQ_PCLK)/ 1000)
#define I2C_SRC_CLK	(BUS_SRC_CLK) // unit is Khz
#define I2C_IRQ 		IRQ_SPI(64)
#define N_I2C_PORT	8
#define I2C_SDA_SKEW	1  

/* Echo-P */
#elif defined(CONFIG_ARCH_SDP1106)
#define I2C_IRQ 	(IRQ_I2C0)
#define N_I2C_PORT	(8)
#define I2C_SDA_SKEW	(1)
