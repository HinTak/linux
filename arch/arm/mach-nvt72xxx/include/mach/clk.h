...
enum MPLL_PAGE_SEL_e {
	CLK_PAGE_B = 0b001,	/* Page B enable */
	CLK_PAGE_0 = 0b010,	/* Page 0 enable */
	CLK_PAGE_A = 0b100,	/* Page A enable */
	CLK_PAGE_F = 0b011,	/* Page F enable */
};

enum MPLL_OFF_e {
	EN_MPLL_OFF_ARM			= 0x62,	/* ARM */
	EN_MPLL_OFF_ARM_CA73	= 0x03, /* ARM CA73 */
	EN_MPLL_OFF_CCI			= 0x23, /* CCI */
...
enum EN_SYS_CLK_MASK {
	...
	/* Partition A, AHB clock mask (0x1000) */
	/* bit[7] */
	EN_SYS_CLK_MASK_AHB_USB20_U0		= ((0x1000 << 3) + 7),
	/* bit[8] */
	EN_SYS_CLK_MASK_AHB_USB20_U1,

	/* Partition C, AHB clock mask (0x1008) */
	/* bit[6] */
	EN_SYS_CLK_MASK_AHB_I2C				= ((0x1008 << 3) + 6),
	/* bit[12] */
	EN_SYS_CLK_MASK_AHB_USB20_U3		= ((0x1008 << 3) + 12),
	/* bit[15] */
	EN_SYS_CLK_MASK_AHB_USB20_U4		= ((0x1008 << 3) + 15),

	/* Partition A, AXI clock mask (0x1100) */
	/* bit[5] */
	EN_SYS_CLK_MASK_AXI_USB20_U0		= ((0x1100 << 3) + 5),
	/* bit[6] */
	EN_SYS_CLK_MASK_AXI_USB20_U1,

	/* Partition C, AXI clock mask (0x1108) */
	/* bit[10] */
	EN_SYS_CLK_MASK_AXI_USB20_U3		= ((0x1108 << 3) + 10),
	/* bit[13] */
	EN_SYS_CLK_MASK_AXI_USB20_U4		= ((0x1108 << 3) + 13),

	/* Partition A, engine clock mask (0x1200) */
	/* bit[12] */
	EN_SYS_CLK_MASK_CORE_USB20_A_12M	= ((0x1200 << 3) + 12),
	/* bit[13] */
	EN_SYS_CLK_MASK_CORE_USB20_U0_30M,
	/* bit[14] */
	EN_SYS_CLK_MASK_CORE_USB20_U1_30M,

	/* Partition C, engine clock mask (0x1208) */
	/* bit[4] */
	EN_SYS_CLK_MASK_CORE_USB20_C_12M	= ((0x1208 << 3) + 4),
	/* bit[5] */
	EN_SYS_CLK_MASK_CORE_USB20_U4_30M,
	/* bit[6] */
	EN_SYS_CLK_MASK_CORE_USB20_U3_30M,
#else /* For KantL and KantS */
	...
	/* bit[6] */
	EN_SYS_CLK_MASK_AHB_I2C			= ((0x08 << 3) + 6),
	/* bit[10] */
