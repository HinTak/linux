...
extern int smp_platform_cpu_kill(unsigned int cpu);
extern void smp_platform_cpu_die(unsigned int cpu);
extern int smp_platform_cpu_disable(unsigned int cpu);
#endif
