...
void jazz_m_clk_rst_iot_off(void)
{
	...
	//sdp_set_clkrst_mux(0x005C0764, 0xffffffff, 0x00000000);
	//Audio I2S TX3 Bit clk Start Code
	{
		u32 Audio_phy_base = SFR_VA + 0xa11000 - 0x00100000;
		sdp_set_clkrst_mux(0x005c07b8, 0x1000, 0x1000);
		writel(0x00010000, Audio_phy_base+0xcc); /* Audio SRC_MIX_PWR I2S_MIX1_0_TX_BCLK_SCALER Value */
		writel(0x0000008A, Audio_phy_base+0xd4); /* Audio SRC_MIX_PWR I2S_MIX1_0_TX_BCLK_SCALER Value *//*requested by hyunho86.kim*/ 	
	}
	dump_clkrst_regs();
}
