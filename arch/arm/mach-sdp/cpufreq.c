			  ...
			  unsigned int relation)
{
	...
	if ((freqs.new > freqs.old) && !safe_arm_volt && arm_regulator) {
	...
	if (safe_arm_volt && arm_regulator)
...
#if !defined(CONFIG_ARCH_SDP1202) /* fox-ap's AVS is moved to TMU */
	int retry = 3;
