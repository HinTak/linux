...
/**
 * sdp_unzip_req - req info and buffer for sdp needs
 */
 ...
 * NOTE: sync and async functions can't be used simultaneously
 */
int sdp_unzip_decompress_sync(struct sdp_unzip_req *uzreq, int off,
			       struct page **opages, int npages, bool may_wait);
