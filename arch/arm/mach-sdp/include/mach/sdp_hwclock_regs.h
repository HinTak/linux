...
#define HWCLOCK_REGS_H
...
#if defined(CONFIG_ARCH_SDP1202)	/* FoxP */
	#define HW_CLOCK_PA   0x10B700C8
	#define HW_CLOCK_FREQ 24000			/* KHz   */
#elif defined(CONFIG_ARCH_SDP1304)	/* GolfP */
	...
	#define HW_CLOCK_FREQ 24576			/* KHz   */
#elif defined(CONFIG_ARCH_SDP1501)	/* HawkM */
	#define HW_CLOCK_PA   0x007900C0
	#define HW_CLOCK_FREQ 24576			/* KHz   */
#else
	#error Unknown arch
...
#if defined(CONFIG_ARCH_SDP1406) || defined(CONFIG_ARCH_SDP1501)     /* HawkM, JazzM */
