...
const ST_SYS_CLK_RST stSYSClkRst[] =
{
...
#if 0
	{0xD4,	(1UL << 13)},	///< EN_SYS_CLK_RST_CORE_USB30,				bit[13]
#endif
	{0xD4,	(1UL << 27)},	///< EN_SYS_CLK_RST_CORE_USB30_HCLK_D2,		bit[27]

	///< Partition A, AXI clock reset disable/enable (0x70/0x74)
	{0x70,	(1UL << 6)},	///< EN_KER_CLK_RST_AXI_USB20_U0,			bit[6]
	{0x70,	(1UL << 7)},	///< EN_KER_CLK_RST_AXI_USB20_U1,			bit[7]
	...
	{0x90, (1UL << 8)},		///< EN_SYS_CLK_RST_AXI_USB20_U0,			bit[8]
	{0x90, (1UL << 9)},		///< EN_SYS_CLK_RST_AXI_USB20_U0_PCLK,		bit[9]
	{0x90, (1UL << 10)},	///< EN_SYS_CLK_RST_AXI_USB20_U1,			bit[10]
	{0x90, (1UL << 11)},	///< EN_SYS_CLK_RST_AXI_USB20_U1_PCLK,		bit[11]
...
void __init nvt_clk_init(void)
{
	...
	node = of_find_compatible_node(NULL, NULL, "nvt,clkgen");
