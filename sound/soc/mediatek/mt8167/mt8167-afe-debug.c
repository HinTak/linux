...
static const struct afe_dump_reg_attr afe_dump_regs[] = {
	...
	DUMP_REG_ENTRY(SPDIFIN_BASE_ADR),
	DUMP_REG_ENTRY(SPDIFIN_END_ADR),
	DUMP_REG_ENTRY(SPDIFIN_CUR_ADR),
	DUMP_REG_ENTRY(AFE_IRQ_CNT13),
	DUMP_REG_ENTRY(AFE_MEMIF_PBUF2_SIZE),
	DUMP_REG_ENTRY(MPHONE_MULTI_CON0),
	DUMP_REG_ENTRY(SPDIFIN_MEMIF_CON0),
	...
	DUMP_REG_ENTRY(AFE_SINEGEN_CON_SPDIFIN),
