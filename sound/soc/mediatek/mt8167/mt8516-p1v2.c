...
static int mt8516_p1v2_suspend_post(struct snd_soc_card *card)
{
...
static int mt8516_p1v2_resume_pre(struct snd_soc_card *card)
{
	struct mt8516_p1_priv *card_data;
	int ret;
...
static struct snd_soc_card mt8516_p1v2_card = {
	...
	.suspend_post = mt8516_p1v2_suspend_post,
	.resume_pre = mt8516_p1v2_resume_pre,
};
