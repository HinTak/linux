...
/**
 * samsung asoc driver porting
 * porting from mt8156 kernel 4.4 to kernel 4.1
 *
 */
/* for samsung asoc driver porting. */
#define SAMSUNG_PORTING
#ifdef SAMSUNG_PORTING
