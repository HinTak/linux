...
#if defined(CONFIG_SND_SOC_DBMDX_IOCTL_SUPPORT)
#if !defined(DBMDX_IOCTL_SUPPORT)
#define DBMDX_IOCTL_SUPPORT		1
#endif
#endif
...
#define DBMDX_BUFFERING_OPT_BUFFER_WITH_BACKLOG		0x0004
#define DBMDX_BUFFERING_OPT_STREAM_WITH_BACKLOG		0x0008
...
#define DBMDX_AVD_OPT_BUFFERING_WITH_BACKLOG		0x0020
