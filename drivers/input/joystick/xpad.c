...
/* To avoid compiler error caused by enabling hid-sony */
#ifdef CONFIG_POWER_SUPPLY
#undef CONFIG_POWER_SUPPLY
#define DEFINE_CONFIG_POWER_SUPPLY
#endif
...
static const struct xpad_device {
	...
	{ 0x24c6, 0x541a, "PowerA Xbox One Mini Wired Controller", FLAG_NEEDS_RUMBLE_TO_INITIALIZE, XTYPE_XBOXONE_ELITE },
...
#ifdef DEFINE_CONFIG_POWER_SUPPLY
