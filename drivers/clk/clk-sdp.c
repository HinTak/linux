...
u32 sdp_read_clkrst_mux(u32 phy_addr)
{
	void __iomem *addr;
	u32 val;
	u32 val1 = (unsigned int)reg_phy_base_ap & 0xFFFF0000;
	u32 val2 = (unsigned int)reg_phy_base_mp & 0xFFFF0000;
	...
	if ((phy_addr&0xFFFF0000) == val1)
	{		
		addr = (void *) ((u32) reg_base_ap + (phy_addr - (u32) reg_phy_base_ap));
	}
	else if ((phy_addr&0xFFFF0000) == val2) 
	{		
		addr = (void *) ((u32) reg_base_mp + (phy_addr - (u32) reg_phy_base_mp));
	}
