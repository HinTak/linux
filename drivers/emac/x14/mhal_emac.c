...
void MHal_EMAC_trim_phy( void )
{
    ...
    uRegVal &= 0xc0;
    uEfuVal1_tmp &= 0x3f;
    uRegVal |= uEfuVal1_tmp;
    MHal_EMAC_WritReg8(0x0034, 0x69, uRegVal);

    uRegVal = MHal_EMAC_ReadReg8(0x0034, 0x61);
    uRegVal &= 0xf0;
    uRegVal |= (uEfuVal1 >> 6);
    uRegVal |= (u8)((uEfuVal2 & 0x03) << 2);
    MHal_EMAC_WritReg8(0x0034, 0x61, uRegVal);
}

void MHal_EMAC_phy_amp(s32 offset)
{
    u32 uRegVal1;
	u32 uRegVal2;
	s32 idx;
    ...
    uRegVal1 = *( ( u32 * ) ( ( u32 ) 0xFD004000 +  0x0A*4) );

	uRegVal1 = uRegVal1 & 0x0001;
	uRegVal2 = *( ( u32 * ) ( ( u32 ) 0xFD004000 +  0x09*4) );
...
{
    *( ( u32 * ) ( ( u32 ) 0xFD204200 +  0x1D*4) ) = 0x0100; //swith RX discriptor format to mode 1
    //emac_clk gen
#if defined(CONFIG_MSTAR_PreX14)
#ifdef CONFIG_ETHERNET_ALBANY
    MHal_EMAC_TX_10MB_lookUp_table();
    //MHal_EMAC_phy_amp(2);
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x6F*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x6F*4) ) & 0xFF00) | 0x0059 );
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x7A*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x7A*4) ) & 0xFF00) | 0x0021 );
    *( ( u32 * ) ( ( u32 ) 0xFD245000 +  0x39*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245000 +  0x39*4) ) & 0xFF00) | 0x0080 );
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x5B*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x5B*4) ) & 0x00FF) | 0x0700 );
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x65*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x65*4) ) & 0x00FF) | 0x1100 );
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x66*4) ) = 0xD180;
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x6A*4) ) = (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x6A*4) ) & 0xFF00);
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x5C*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x5C*4) ) & 0x00FF) | 0x4000 );
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x5D*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x5D*4) ) & 0x00FF) | 0x0500 );
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x58*4) ) = 0x6002;
    /* resolve  that PHY cannot link when distance over 100M */
    //*( ( u32 * ) ( ( char * ) 0xBF203C00 +  0x5A*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF203C00 +  0x5A*4) ) & 0xFF00) | 0x0010 );
    *( ( u32 * ) ( ( u32 ) 0xFD245000 +  0x39*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245000 +  0x39*4) ) & 0xFFF7)); //unset loop_back_enable
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x5A*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x5A*4) ) & 0xFF00) | 0x0056 ); //gain shift
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x27*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x27*4) ) & 0x00FF) | 0x0200 ); //det max
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x28*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x28*4) ) & 0x00FF) | 0x0100 ); //det min
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x3B*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x3B*4) ) & 0x00FF) | 0x1800); //snr len (emc noise)
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x21*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x21*4) ) & 0x00FF) | 0x1500); //snr k value
    /* For pass ESD test */
    *( ( u32 * ) ( ( u32 ) 0xFD245000 +  0x62*2) ) = 0x112b;
    *( ( u32 * ) ( ( u32 ) 0xFD245000 +  0x60*2) ) = 0x06a4;
    // Set MII Mode
    *( ( u32 * ) ( ( u32 ) 0xFD201600 +  0x60*4) ) = 0x0000;
    *( ( u32 * ) ( ( u32 ) 0xFD201600 +  0x61*4) ) = 0x0000;
#else
    *( ( u32 * ) ( ( u32 ) 0xFD201600 +  0x60*4) ) = 0x0400;
    *( ( u32 * ) ( ( u32 ) 0xFD201600 +  0x61*4) ) = 0x0004;
#endif
#else
    ...
    //MHal_EMAC_TX_10MB_lookUp_table();
    //MHal_EMAC_phy_amp(2);
    *( ( u32 * ) ( ( u32 ) 0xFD001C00 +  0x30*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD001C00 +  0x30*4) ) & 0xFF00) | 0x0040 ); //PD_ETH33
    *( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x27*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x27*4) ) & 0x00FF) | 0x0200 ); //det max
    *( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x28*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x28*4) ) & 0x00FF) | 0x0100 ); //det min
    *( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x3B*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x3B*4) ) & 0x00FF) | 0x1800 ); //snr len (emc noise)
    *( ( u32 * ) ( ( u32 ) 0xFD006400 +  0x39*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD006400 +  0x39*4) ) & 0xFF00) | 0x0080 ); //Lpbk_enable set to 0
    *( ( u32 * ) ( ( u32 ) 0xFD006400 +  0x16*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD006400 +  0x16*4) ) & 0x00FF) | 0x7c00 ); //Disable EEE
    *( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x7E*4) ) = 0x0000;                                                                    //Power-on LDO25/LDO11
    *( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x5B*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x5B*4) ) & 0x00FF) | 0x0700 ); //Power-on ADC
    *( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x65*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x65*4) ) & 0x00FF) | 0x1100 ); //Power-on BGAP
    *( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x66*4) ) = 0xD020;                                                                    //Power-on ADCPL, Power-on ADCPL
    *( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x6A*4) ) = (*( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x6A*4) ) & 0xFF00);              //Power-on LPF_OP
    *( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x5C*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x5C*4) ) & 0x00FF) | 0x4000 ); //Power-on LP
    *( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x5D*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x5D*4) ) & 0x00FF) | 0x4500 ); //Power on REF
    *( ( u32 * ) ( ( u32 ) 0xFD006800 +  0x1D*4) ) = 0x0003;                                                                    //PD_TX_IDAC, PD_TX_LD = 0
    *( ( u32 * ) ( ( u32 ) 0xFD006800 +  0x62*4) ) = (*( ( u32 * ) ( ( u32 ) 0xFD006800 +  0x62*4) ) & 0x00FF);              //100gat
    *( ( u32 * ) ( ( u32 ) 0xFD006800 +  0x18*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD006800 +  0x18*4) ) & 0xFF00) | 0x0043 ); //200gat
    *( ( u32 * ) ( ( u32 ) 0xFD006800 +  0x1C*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD006600 +  0x1C*4) ) & 0x00FF) | 0x4100 ); //en_100t_phase;  [6] save2x_tx
    /* For pass ESD test */
    *( ( u32 * ) ( ( u32 ) 0xFD006400 +  0x31*4) ) = 0x112b;
    *( ( u32 * ) ( ( u32 ) 0xFD006400 +  0x30*4) ) = 0x06a4;
    // Set MII Mode
    *( ( u32 * ) ( ( u32 * ) 0xFD201600 +  0x60*4) ) = 0x0000;
    *( ( u32 * ) ( ( u32 * ) 0xFD201600 +  0x61*4) ) = 0x0000;
    *( ( u32 * ) ( ( u32 * ) 0xFD201600 +  0x62*4) ) = 0x0001; //Disable RX clk from exterenel crystal
#else
    *( ( u32 * ) ( ( u32 ) 0xFD201600 +  0x60*4) ) = 0x0400;
    *( ( u32 * ) ( ( u32 ) 0xFD201600 +  0x61*4) ) = 0x0004;
    *( ( u32 * ) ( ( u32 ) 0xFD201600 +  0x62*4) ) = 0x0000; //Enable RX clk from exterenel crystal
#endif
#endif
#endif

    //chiptop [15] allpad_in
    *( ( u32 * ) ( ( u32 ) 0xFD203C00 + 0x50*4 ) ) &= 0x7FFF;
    //chiptop pad_top [9:8]
#ifdef CONFIG_ETHERNET_ALBANY
    *( ( u32 * ) ( ( u32 ) 0xFD203C00 + 0x6F*4 ) ) &= (u32)(~0x0100);
#else
    *( ( u32 * ) ( ( u32 ) 0xFD203C00 + 0x6F*4 ) ) |= 0x0100;  //et_mode = 1
#endif
}
...
#ifdef CONFIG_ETHERNET_ALBANY
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x5B*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x5B*4) ) & 0x00FF) | 0x1700 );
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x65*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x65*4) ) & 0x00FF) | 0x0300 );
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x66*4) ) = 0xD990;
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x6A*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x6A*4) ) & 0xFF00) | 0x0020);
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x5C*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x5C*4) ) & 0x00FF) | 0x4100 );
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x5D*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x5D*4) ) & 0x00FF) | 0xC500 );
    *( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x58*4) ) = 0x7003;
#endif
}
