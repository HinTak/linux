...
#if (defined(CONFIG_MSTAR_PreX14) || defined(CONFIG_MSTAR_X14)) && (_USB_TURN_ON_TT_THROTTLE_MODE_PATCH)
...
//
#if defined(CONFIG_MSTAR_PreX14) || defined(CONFIG_MSTAR_X14)
// same configuration as SAMSUNG_PATCH_WITH_USB_ENHANCEMENT
...
#if defined(ENABLE_12US_EOF1) && (defined(CONFIG_MSTAR_PreX14) || defined(CONFIG_MSTAR_X14))
...
#if defined(CONFIG_MSTAR_PreX14) || defined(CONFIG_MSTAR_X14)	//tony ignore oc
...
static void ehci_work (struct ehci_hcd *ehci)
{
	 ...
	 */
#if (defined(CONFIG_MSTAR_PreX14) || defined(CONFIG_MSTAR_X14)) && (_USB_T3_WBTIMEOUT_PATCH)
...
#if defined(CONFIG_MSTAR_PreX14) || defined(CONFIG_MSTAR_X14)	//tony add for FUSB200
	ehci->i_thresh = 8;
