...
#if (defined(CONFIG_MSTAR_PreX14) || defined(CONFIG_MSTAR_X14)) && (_USB_SPLIT_MDATA_BLOCKING_PATCH)
...
#if (defined(CONFIG_MSTAR_PreX14) || defined(CONFIG_MSTAR_X14)) && (_USB_SHORT_PACKET_LOSE_INT_PATCH)
