...
static struct cpufreq_governor cpufreq_gov_foxap;
#endif
...
static void update_sampling_rate(unsigned int new_rate)
{
	...
	for_each_online_cpu(cpu) {
		...
		if (!policy)
			continue;
		if (policy->governor != &cpufreq_gov_foxap) {
...
static struct od_ops od_ops = {
	...
	.powersave_bias_init_cpu = foxap_powersave_bias_init_cpu,
...
MODULE_DESCRIPTION("'cpufreq_foxap' - A dynamic cpufreq governor for "
