...
#ifndef _FSR_LLD_NTK_688_REG_
#define _FSR_LLD_NTK_688_REG_
...
#define REG_NFC_BASE                    (nfc_reg_base)
#else
...
#define NFC_INT_BLANK_PAGE                      (1 << 22)
...
#define NFC_STAT_GET_BCH_ECC_COUNT(n)           ((n >> 14) & 0x3F)
#define NFC_STAT_GET_BCH_ECC(n)                 ((n >> 20) & 0x3)
...
#define NFC_SYS_CTRL2_BLANK_ENABLE                  (0x1 << 6)
