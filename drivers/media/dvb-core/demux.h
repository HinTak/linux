...
struct dmx_demux {
	...
	int (*get_pwm) (struct dmx_demux* demux, unsigned int num, unsigned int *regvalue);
	
	int (*set_pwm) (struct dmx_demux* demux, unsigned int num, unsigned int regvalue);
	...
	int (*clearall_sec_filters) (struct dmx_demux *demux);
};
