...
#ifndef __USB_ENABLE_NIKEM__
#define __USB_ENABLE_NIKEM__
...
/*
typedef enum {
	PLAT_NIKEM_BUILTIN = 0x0,
	PLAT_NIKEM_SERIF = 0x1,		// SERIF 3.0
	PLAT_NIKEM_FRAME_BUILTIN = 0x2, // FRAME Essential
	PLAT_NIKEM_OC = 0x4,
	PLAT_NIKEM_FRAME_OC = 0x6,	// FRAME 4.0
	PLAT_NIKEM_SERO = 0x07,		// SERO 2.0
	PLAT_NIKEM_WALL, // TEMP VALUE 
} PLATFORM_TYPE;
