...
/* fill a qtd, returning how much of the buffer we were able to queue up */
		...
		(defined(CONFIG_ARCH_SDP_NIKE) || defined(CONFIG_ARCH_SDP1803) || (defined(CONFIG_ARCH_SDP1601) && defined(__KANTM_REV_1__)))		// Only Muse.M & Kant.M2 TV
// Nike.M       : 0 == Built-in,2 == M Frame Built-in,  4 == M OC,      6 == M OC Frame,      7 == M SERO
// Muse.M	: 0 == L,	2 == M Built-in,	7 == M OC
// Kant.M2	: 0 == M2e,	2 == M2 Built-in,	3 == M2 OCL,	4 == M2 OCL Frame,	7 == M2 OCL 8K
...
#if defined(CONFIG_USB_MODULE) && defined(CONFIG_SAMSUNG_USB_TV_PRODUCT) && \
		(defined(CONFIG_ARCH_SDP1803) || defined(CONFIG_ARCH_SDP_NIKE) || (defined(CONFIG_ARCH_SDP1601) && defined(__KANTM_REV_1__)))		// Only Muse.M & Kant.M2 TV
...
#ifdef CONFIG_ARCH_SDP1803
					if((bdinfo == 7) && (bus && (bus->busnum == 2 || bus->busnum == 3)))	// Muse.M OC
#elif CONFIG_ARCH_SDP_NIKE
					if((bdinfo == 4) || (bdinfo == 6))	//Nike OC and FRAME OC
#elif CONFIG_ARCH_SDP1601
					if(((bdinfo == 3) || (bdinfo == 4) || (bdinfo == 7)) && (bus && (bus->busnum == 2 || bus->busnum == 3)))	// Kant.M2 OCL, Frame, 8K
#endif
					{
