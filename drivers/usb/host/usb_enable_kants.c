...
int init_usb_module(struct platform_device *pdev)
{
	...
	else	// kants2 su2 do not use usb_en gpio
	{
		ret = 0;
	}	
	return ret;
...
/*	=====================================================
	...
	-----------------------------------------------------
	|		| Kant.S2/SU2| Built-in		| Micom	|
	=====================================================	*/
// Set usb power
void set_usb_power(int status)
{
	// IMPORTANT : It should always be called in GPIO, 3G order
	if(soc_is_kants() || soc_is_kantsu()) // kants2 su2 do not use usb_en gpio
	{
...
/*	=====================================================
	...
	| ** Kant.S2
	|	-. Built-in	: 4-1(by micom)						|	
	| ** Kant.SU2										|
	|	-. Built-in	: 2-1(by micom)						|	
	=====================================================	*/
...
void reset_tvkey_dongle(int bus_num)
{
	...
	else if(soc_is_kants2() || soc_is_kantsu2())
	{	
