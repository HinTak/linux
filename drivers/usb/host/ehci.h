...
#define	DEFAULT_I_TDPS		1024		/* some HCs can do less */
	...
	unsigned		retry_negotiation:1;
	unsigned		force_reset_on_ls:1;
	...
	unsigned		has_synopsys_portreset:1;	/* HSIC portreset WA */
	u8			sbrn;		/* packed release number */
	int			retry_negotiation_cnt;
	int			force_reset_on_ls_cnt;
