...
#if defined(CONFIG_ARCH_NVT72673) || defined(CONFIG_ARCH_NVT72671D)
static u32 phy_hi_reset_done = 0;
#define PORT2_PHY3_OTHER_CFG_0		0xfd18c158
#define PORT5_PHY3_OTHER_CFG_0		0xfd17c158
#endif
...
static const struct nvt_ehci_platform_data ehci_pdata[4] = {
	{	/* id = 0 */
		.hclk_rst		= EN_SYS_CLK_RST_AHB_USB20_U0,
		.pclk_rst		= EN_SYS_CLK_RST_AHB_USB20_U0_PCLK,
		.aclk_rst		= EN_SYS_CLK_RST_AXI_USB20_U0,
		.uclk_rst		= EN_SYS_CLK_RST_CORE_USB20_U0,
		.clk_src		= EN_SYS_CLK_SRC_USB_U0_U1_30M,
	},
	{	/* id = 1 */
		.hclk_rst		= EN_SYS_CLK_RST_AHB_USB20_U1,
		.pclk_rst		= EN_SYS_CLK_RST_AHB_USB20_U1_PCLK,
		.aclk_rst		= EN_SYS_CLK_RST_AXI_USB20_U1,
		.uclk_rst		= EN_SYS_CLK_RST_CORE_USB20_U1,
		.clk_src		= EN_SYS_CLK_SRC_USB_U0_U1_30M,
	},
	{	/* id = 2 */
		.hclk_rst		= EN_SYS_CLK_RST_AHB_USB20_U3,
		.pclk_rst		= EN_SYS_CLK_RST_AHB_USB20_U3_PCLK,
		.aclk_rst		= EN_SYS_CLK_RST_AXI_USB20_U3,
		.uclk_rst		= EN_SYS_CLK_RST_CORE_USB20_U3,
		.hclk_rst_u3	= EN_SYS_CLK_RST_AHB_USB30,
		.clk_src		= EN_SYS_CLK_SRC_USB_U2_U3_30M,
	},
	{	/* id = 3 */
		.hclk_rst		= EN_SYS_CLK_RST_AHB_USB20_U4,
		.pclk_rst		= EN_SYS_CLK_RST_AHB_USB20_U4_PCLK,
		.aclk_rst		= EN_SYS_CLK_RST_AXI_USB20_U4,
		.uclk_rst		= EN_SYS_CLK_RST_CORE_USB20_U4,
		.hclk_rst_u3	= EN_SYS_CLK_RST_AHB_USB30,
		.clk_src		= EN_SYS_CLK_SRC_USB_U2_U3_30M,
	},
};
#elif defined(CONFIG_ARCH_NVT72671D)
static const struct nvt_ehci_platform_data ehci_pdata[2] = {
	{	/* id = 0 */
		.hclk_rst		= EN_SYS_CLK_RST_AHB_USB20_P0,
		.pclk_rst		= EN_SYS_CLK_RST_AHB_USB20_P0_PCLK,
		.aclk_rst		= EN_SYS_CLK_RST_AXI_USB20_P0,
		.uclk_rst		= EN_SYS_CLK_RST_CORE_USB20_P0,
		.hclk_rst_u3	= EN_SYS_CLK_RST_AHB_USB30_P5,
		.clk_src		= EN_SYS_CLK_SRC_USB_U0_U1_30M,
	},
	{	/* id = 1 */
		.hclk_rst		= EN_SYS_CLK_RST_AHB_USB20_P3,
		.pclk_rst		= EN_SYS_CLK_RST_AHB_USB20_P3_PCLK,
		.aclk_rst		= EN_SYS_CLK_RST_AXI_USB20_P3,
		.uclk_rst		= EN_SYS_CLK_RST_CORE_USB20_P3,
		.hclk_rst_u3	= EN_SYS_CLK_RST_AHB_USB30_P2,
		.clk_src		= EN_SYS_CLK_SRC_USB_U2_U3_30M,
	},
};
#else
static const struct nvt_ehci_platform_data ehci_pdata[4] = {
	...
	{	/* id = 2 */
		.hclk_rst		= EN_SYS_CLK_RST_AHB_USB20_U2,
		.pclk_rst		= EN_SYS_CLK_RST_AHB_USB20_U2_PCLK,
		.aclk_rst		= EN_SYS_CLK_RST_AXI_USB20_U2,
		.uclk_rst		= EN_SYS_CLK_RST_CORE_USB20_U2,
		.clk_src		= EN_SYS_CLK_SRC_USB_U2_U3_30M,
	},
	{	/* id = 3 */
		.hclk_rst		= EN_SYS_CLK_RST_AHB_USB20_U3,
...
static int nvt_disconnect_threshold_get(void *data, u64 *val)
{
	...
	/* usb port 3,4 (id 2,3) disconnect threshold setting belong to different register */
	if (id == 2 || id == 3)
		*val = (usb_ioremap_read(PORT2_PHY3_OTHER_CFG_0) & 0x30) >> 4;
	else
	...
	if (id == 0)
		*val = (usb_ioremap_read(PORT5_PHY3_OTHER_CFG_0) & 0x30) >> 4;
	else /* if (id == 1) */
		*val = (usb_ioremap_read(PORT2_PHY3_OTHER_CFG_0) & 0x30) >> 4;
#else
	*val = (readl(pphy->phy_regs + 0x14) & 0x3);
...
static int nvt_disconnect_threshold_set(void *data, u64 val)
{
	...
	/* usb port 3,4 (id 2,3) disconnect threshold setting belong to different register */
	if (id == 2 || id == 3) {
		reg_val = usb_ioremap_read(PORT2_PHY3_OTHER_CFG_0);
		reg_val = (reg_val & (~0x30)) | v << 4;
		usb_ioremap_write(PORT2_PHY3_OTHER_CFG_0, reg_val);
	} else {
	...
	if (id == 0) {
		reg_val = usb_ioremap_read(PORT5_PHY3_OTHER_CFG_0);
		reg_val = (reg_val & (~0x30)) | v << 4;
		usb_ioremap_write(PORT5_PHY3_OTHER_CFG_0, reg_val);
	} else { /* if (id == 1) */
		reg_val = usb_ioremap_read(PORT2_PHY3_OTHER_CFG_0);
		reg_val = (reg_val & (~0x30)) | v << 4;
		usb_ioremap_write(PORT2_PHY3_OTHER_CFG_0, reg_val);
...
static void NT72668_init(struct platform_device *dev)
{
	struct device_node *dn = dev->dev.of_node;
	struct usb_hcd *hcd = platform_get_drvdata(dev);
	const struct nvt_ehci_platform_data *pdata = ehci_pdata;
	u32 id;
 ...
 * |		P0		  | 	   P3		 |	 P2(U3)   |   P5(U3)   |
 * +------------------+------------------+------------+------------+
 * |couple w/ P5(U3)  |couple w/ P2(U3)  |			  | 		   |
 * +------------------+------------------+------------+------------+
 */
#if defined(CONFIG_ARCH_NVT72673)
	/*
	 * if usb 2.0 phy group 2 is powered down by onboot,
	 * we need to reset usb 3.0 phy
	 */
	if (id == 2 || id == 3) {
		if (phy_hi_reset_done == 0) {
			phy_hi_reset_done = 1;

			/* set usb30 hclk sw reset */
			SYS_SetClockReset(pdata[id].hclk_rst_u3, true);
			udelay(0x20);

			/* set usb30 hclk sw clear */
			SYS_SetClockReset(pdata[id].hclk_rst_u3, false);
			udelay(0x20);
		}
	}
#elif defined(CONFIG_ARCH_NVT72671D)
	...
	SYS_SetClockReset(pdata[id].pclk_rst, true);
	udelay(0x20);
	SYS_SetClockReset(pdata[id].pclk_rst, false);

	usb_phy_init(hcd->usb_phy);

	/* set uclk sw reset */
	SYS_SetClockReset(pdata[id].uclk_rst, true);
	udelay(0x20);

	/* set hclk sw reset */
	SYS_SetClockReset(pdata[id].hclk_rst, true);
	udelay(0x20);

	/* set aclk sw reset */
	SYS_SetClockReset(pdata[id].aclk_rst, true);
	udelay(0x20);

	/* set aclk sw clear */
	SYS_SetClockReset(pdata[id].aclk_rst, false);
	udelay(0x20);

	/* set hclk sw clear */
	SYS_SetClockReset(pdata[id].hclk_rst, false);
	udelay(0x20);

	/* set uclk sw clear */
	SYS_SetClockReset(pdata[id].uclk_rst, false);
	udelay(0x20);

	/* set UCLK to PHY 30M */
	SYS_CLK_SetClockSource(pdata[id].clk_src, 1);
	udelay(0x20);
