...
#if defined(SAMSUNG_PATCH_WITH_USB_ENHANCEMENT)
...
#if defined(CONFIG_ARCH_MXC) || defined(CONFIG_ARCH_NVT72671D)
...
/*-------------------------------------------------------------------------*/
#if defined(CONFIG_USB_DEBUG) || defined(CONFIG_ARCH_SDP1803) || defined(CONFIG_ARCH_SDP_NIKE)
...
#if defined(CONFIG_SAMSUNG_USB_PARALLEL_RESUME)||defined(CONFIG_SAMSUNG_USB_PARALLEL_RESUME_MODULE)
struct snapshot_hcd snapshot_ehci_hcd={
    .name="EHCI SNAPSHOT",
    .udev_speed=USBDEV_HIGH_SPEED,
    .valid=1,
}; 
#endif
...
#if defined(CONFIG_SAMSUNG_USB_PARALLEL_RESUME)||defined(CONFIG_SAMSUNG_USB_PARALLEL_RESUME_MODULE)
    register_snapshot_hcd(&snapshot_ehci_hcd);
#endif
	return retval;
...
#if defined(CONFIG_SAMSUNG_USB_PARALLEL_RESUME)||defined(CONFIG_SAMSUNG_USB_PARALLEL_RESUME_MODULE)
    deregister_snapshot_hcd(&snapshot_ehci_hcd);
#endif
