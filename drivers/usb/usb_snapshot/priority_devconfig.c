...
product_info devconfig_info[MAX_PRIORITY_DEVICES+1]  = {
	...
	{.idVendor =  0x04E8, .idProduct = 0x20B0, .priority = 5, .dependancy_index = 0xFF, .is_checked = 0, .usb_family = WIFI_FAMILY, .devnode = NULL}, /* MT7668_MOB_5G 2020Year*/
	{.idVendor =  0x04E8, .idProduct = 0x20B1, .priority = 5, .dependancy_index = 0xFF, .is_checked = 0, .usb_family = WIFI_FAMILY, .devnode = NULL}, /* MT7668_WIFI/BT Combo Chip(MT7668) on IR board for 2020 Year */
	{.idVendor =  0x04E8, .idProduct = 0x20B4, .priority = 5, .dependancy_index = 0xFF, .is_checked = 0, .usb_family = WIFI_FAMILY, .devnode = NULL}, /* MT7668_WIFI/BT Combo for 2020 Year*/
	{.idVendor =  0x04E8, .idProduct = 0x20B5, .priority = 5, .dependancy_index = 0xFF, .is_checked = 0, .usb_family = WIFI_FAMILY, .devnode = NULL}, /* MT7668_WIFI/BT Combo for 2020 Year Ultra slim model*/
	{.idVendor =  0x04E8, .idProduct = 0x20B6, .priority = 5, .dependancy_index = 0xFF, .is_checked = 0, .usb_family = WIFI_FAMILY, .devnode = NULL}, /*MT7668_WCT732M COMBO for 2020 Year*/
	{.idVendor =  0x04E8, .idProduct = 0x20B7, .priority = 5, .dependancy_index = 0xFF, .is_checked = 0, .usb_family = WIFI_FAMILY, .devnode = NULL}, /*MT7668_WCT731M COMBO for 2020 Year*/
	{.idVendor =  0x04E8, .idProduct = 0x20B8, .priority = 5, .dependancy_index = 0xFF, .is_checked = 0, .usb_family = WIFI_FAMILY, .devnode = NULL}, /*MT7668_WCT730M COMBO for 2020 Year*/
	{.idVendor =  0x04E8, .idProduct = 0x20B9, .priority = 5, .dependancy_index = 0xFF, .is_checked = 0, .usb_family = WIFI_FAMILY, .devnode = NULL}, /*MT7668_WCT733M COMBO for 2020 Year*/
