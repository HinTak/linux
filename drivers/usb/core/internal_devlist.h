...
#define IS_WIFI \
		...
		|| ((udev->descriptor.idVendor == 0x04e8) && \
			...
			|| (udev->descriptor.idProduct == 0x20b0) \
			|| (udev->descriptor.idProduct == 0x20B1) \
			|| (udev->descriptor.idProduct == 0x20B4) \
			|| (udev->descriptor.idProduct == 0x20b5) \
			|| (udev->descriptor.idProduct == 0x20B6) \
			|| (udev->descriptor.idProduct == 0x20B7) \
			|| (udev->descriptor.idProduct == 0x20B8)	\
			|| (udev->descriptor.idProduct == 0x20B9))) \
		|| ((udev->descriptor.idVendor == 0x0e8d) && \
