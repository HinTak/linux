...
#if defined(CONFIG_USB_F_MTP) || defined(CONFIG_USB_F_PTP)
#include "f_mtp.c"
#endif
#include "f_eem.c"
#include "f_rndis.c"
...
#else
	config = kzalloc(sizeof(config[0]), GFP_KERNEL);
#endif
	f->config = config;
	if (!config)
		return -ENOMEM;
...
static struct android_usb_function *supported_functions[] = {
	...
	&acm_function,
#endif
#ifdef CONFIG_USB_F_MTP
	&mtp_function,
#endif
#ifdef CONFIG_USB_F_PTP
	&ptp_function,
#endif
#ifdef CONFIG_USB_F_EEM
	&eem_function,
