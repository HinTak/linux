...
static int tmu_get_temp(void *data, long *temp)
{
...
static int tmu_get_trend(void *p, long *trend)
{
	...
	if (tmu->tzd->temperature >= (tmu->temp_passive - IMX_TEMP_PASSIVE_COOL_DELTA))
...
static int imx8mm_tmu_probe(struct platform_device *pdev)
{
	...
	tmu->tzd = thermal_zone_of_sensor_register(&pdev->dev, 0, tmu, &tmu_tz_ops);
