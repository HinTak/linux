...
#define TRACE_SUPPRESS_OFF	0	//trace all of cmd
#define TRACE_SUPPRESS_ON	1	//suppress cmd
...
static inline void mmc_set_gendisk(struct gendisk *disk){};
