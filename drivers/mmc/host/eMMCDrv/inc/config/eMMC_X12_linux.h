...
#define REG_BANK_CLKGEN                     0x580U // 0x100B
...
//------------------------------
#define REG_BANK_CHIPTOP                    0xF00 // 0x101E
...
#define REG_BANK_GPIO                       0x1580 // 0x102B
#define REG_GPIO_BASE                       GET_REG_ADDR(RIU_BASE, REG_BANK_GPIO)
#define REG_GPIO_0x06                       GET_REG_ADDR(REG_GPIO_BASE, 0x06) // 0xFD20_5618

//-----------------------------------------------------------------------------
#define REG_BANK_TIMER1                     0x1800 // 0x0030
...
// API declarations
//=====================================================
extern void dump_mem(char *buf, int count);
...
extern void eMMC_AbortIntrWaitEvent(void);
extern void eMMC_ContinueIntrWaitEvent(void);
...
#define HW_TIMER_DELAY_20ms                 (  20 * HW_TIMER_DELAY_1ms)
#define HW_TIMER_DELAY_50ms                 (  50 * HW_TIMER_DELAY_1ms)
