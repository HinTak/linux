...
#define FCIE_CLK_TEST               GET_REG_ADDR(FCIE_REG_BASE_ADDR, 0x36)
...
#define BIT_ADMA_END			BIT6
#define BIT_CARD_DMA_END            BIT11
#define BIT_MIU_LAST_DONE           BIT14
#define BIT_CARD_BOOT_DONE          BIT15
#define BIT_ALL_CARD_INT_EVENTS		(BIT_MMA_DATA_END|BIT_SD_DATA_END|BIT_CARD_DMA_END|BIT_MIU_LAST_DONE| \
					    BIT_SD_CMD_END|BIT_ADMA_END|BIT_CARD_BOOT_DONE)
					// 0xC847
#define BIT_ALL_DMA_EVENT		(BIT_MMA_DATA_END|BIT_SD_DATA_END|BIT_CARD_DMA_END|BIT_MIU_LAST_DONE)
					// 0x4805
...
#define BIT_ADMA_EN			BIT6
#define BIT_ABORT_EN			BIT8
#define BIT_ADMA_DEBUG_MODE_SHIFT	9
...
/* FCIE_SD_STATUS 0x12 */
#define BIT_SD_R_CRC_ERR            BIT0 // data crc error
...
#define BITS_SD_DAT_CHK            (BIT_SD_R_CRC_ERR|BIT_SD_W_FAIL|BIT_SD_W_CRC_ERR)
#define BIT_SD_RSP_TIMEOUT          BIT3 // response time out in 64 clocks
#define BIT_SD_RSP_CRC_ERR          BIT4 // response crc error
#define BITS_SD_RSP_CHK            (BIT_SD_RSP_TIMEOUT|BIT_SD_RSP_CRC_ERR)
...
/* FCIE_REG_2Dh 0x2D */
#define BIT_DDR_TIMING_PATCH_RSP    BIT0 // RSP latch timing
...
#define BIT_MACRO_EN			BIT8 // SDR, DDR
...
#define BIT_MACRO_TO_IP_2ND_4X		BIT14
...
//============================================
//CLK_TEST     :offset 0x36
//============================================
#define R_CLK_MIU_TEST          BIT0
#define R_CLK_FCIE_TEST         BIT1
#define R_CLK_MIU_STS           BIT2
#define R_CLK_FCIE_STS          BIT3
/* FCIE_HS200_PATCH 0x3F */
#define BIT_HS200_RD_DAT_PATCH		BIT8
#define BIT_HS200_NORSP_PATCH		BIT9
#define BIT_HS200_W_CRC_PATCH		BIT10
#define BIT_WRITE_CLK_PATCH		BIT11
/* NC_WIDTH 0x41 */
