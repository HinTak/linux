...
#define NVT_ADLL_BIAS					(0xFD1300F8)
#define NVT_ADLL_BIAS_EMMC_PDN				(1<<7)
...
#define ADLL_CFG_SET_ADLL_EN(adllreg_val, n)	\
		((adllreg_val&0xFFF7FFFF)|(n<<19))
