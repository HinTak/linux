...
static struct sdp_busmon_dev nikem_busmon_devs[] = {
	{"peris",     0x320000, 500,  8, true, },
	{"cpu",       0x440000, 600, 16, true, },
	{"gpu",       0x544000, 760, 16, true, },
	{"perin",     0x553000, 250,  8, true, },
	{"ga_r",      0x588000, 450,  8, true, },
	{"ga_w",      0x589000, 450,  8, true, },
	{"hdmi",      0x5bc000, 250,  4, true, },
	{"gp_pln1",   0x5e0000, 600, 16, true, },
	{"gp_pln2",   0x5e4000, 600, 16, true, },
	{"srp",       0x5f0000, 500, 16, true, },
	{"dvde0",     0x840000, 600, 16, true, },
	{"dvde1",     0x841000, 600, 16, true, },
	{"dvde2",     0x842000, 600, 16, true, },
	...
	{"amic",      0x978000,  24,  4, false, },
	{"dmicom",    0x980000, 150,  4, false, },
	{"adsp0",     0xa10000, 760, 16, true, },
	{"adsp1",     0xa18000, 760, 16, true, },
	{"aiow",      0xa2c000, 380,  8, true, },
	{"aior",      0xa2e000, 380,  8, true, },
	{"mfd0",      0xa60000, 333, 16, true, },
	{"mfd1",      0xa62000, 333, 16, true, },
	{"jpeg",      0xa80000, 600,  8, true, },
	{"hen0",      0xaa0000, 300,  8, true, },
	...
	{"nrc_r",     0x7d0000, 300, 16, true, },
	{"nrc_w",     0x7d1000, 300, 16, true, },
	{"gp_pln3",   0x5e8000, 600, 16, true, },
	{"npu",       0xb40000, 500, 16, true, },
	{"snpu_cpu",  0x7e0000, 666, 16, false, },
	{"snpu_dma",  0x7e1000, 666, 16, false, },
	{"snpu_flc",  0x7e2000, 666, 16, false, },
};

static void nikel_fixup_devs(void)
{
	int i;

	for (i = 17; i <= 18; i++)
		nikem_busmon_devs[i].freq = 594; //adsp freq=594

	for (i = 10; i <= 13; i++)
		nikem_busmon_devs[i].freq = 500; //dvde freq=500
...
static int __init sdp_busmon_init(void)
{
	...
	if (soc_is_sdp1601()) {
		...
		sdp_busmon_set_devs(nikem_busmon_devs, ARRAY_SIZE(nikem_busmon_devs));
		sdp_busmon_set_ops(&sdp1803_busmon_ops); /* compatible to nikem */
		sdp_busmon_set_busfreq(500);
	}
	else if (soc_is_nikel()) {
		sdp_busmon_set_devs(nikem_busmon_devs, ARRAY_SIZE(nikem_busmon_devs)-5);
		sdp_busmon_set_ops(&sdp1803_busmon_ops); /* compatible to nikel */
		sdp_busmon_set_busfreq(500);
		nikel_fixup_devs();
	}
