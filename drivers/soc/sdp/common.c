...
static void __init sdp_check_chipid_from_of(void)
{
	...
	else if (of_machine_is_compatible("samsung,sdp-nikem"))
		sdp_chipid_dt = SDP_NIKEM_CHIPID;
	else if (of_machine_is_compatible("samsung,sdp-nikel"))
		sdp_chipid_dt = SDP_NIKEL_CHIPID;
}
