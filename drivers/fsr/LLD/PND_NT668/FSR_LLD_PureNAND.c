...
INT32   NTK_NFCON_ReadPage(UINT32 nDev, UINT32 nRowAddress, UINT32 nColAddress)
{
	...
	if(gEnableECC==1)
		nLLDRe = NFC_ReadPage_WholePage(ucChipEn, nRowAddress, pMBuf, pSBuf, NAND_ECC_TYPE_REEDSOLOMON);
	else
		nLLDRe = NFC_ReadPage_WholePage(ucChipEn, nRowAddress, pMBuf, pSBuf, NAND_ECC_TYPE_NONE_16);
