...
/**
 * @version     LinuStoreIII_1.2.0_b040-FSR_1.2.1p1_b146_RTM
...
/* 2013_02_14_ramya.bt@samsung.com. Bug fix for issue QA2012120001.
 * Declaring and exporting the gbSTLOpenFlag from FSR_STL_Open()
 * GFP_ATOMIC flag is used in case the malloc request is for FSR_STL_Open
 * for other cases,GFP_KERNEL is used
 * This is to prevent memory reclaim during FSR_STL_Open
 */

BOOL32 gbSTLOpenFlag = 0;
EXPORT_SYMBOL(gbSTLOpenFlag);
