...
#if defined (FSR_STL_FOR_PRE_PROGRAMMING) || defined (FSR_STL_WITH_SAFE_DEFRAGMENT)
/* For pre-programming or with safe defragment */
...
#if defined (FSR_STL_WITH_SAFE_DEFRAGMENT)
PUBLIC INT32    FSR_STL_Defragment_Safe (UINT32      nVol,
                                    UINT32      nPartID,
									UINT32      nFlag);
#endif /* defined (FSR_STL_WITH_SAFE_DEFRAGMENT) */
