...
#define BTUSB_VERSION "untracked version - latest know is BSA0106_00.29.00-3-gf219f79"
...
struct btusb
{
    ...
    /* must be here before the pending buffer */
    unsigned long room_for_device_object;
    struct btusb_voice_tx *p_voicetxIrpList;
