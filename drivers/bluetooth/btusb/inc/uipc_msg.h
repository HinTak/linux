...
/* Common Sync CP type for MM and BTC */
typedef struct
{
    UINT16 id;                         /* CP Id: None/DTCP/SCMS */
    UINT8  scms_hdr;                   /* SCMS Header */
} tAVDT_SYNC_CP;

/* AVDT_SYNC_CP_TO_BTC_LITE_REQ and AVDT_SYNC_CP_TO_LITE_RESP */
typedef struct
{
    UINT16        lcid;
    tAVDT_SYNC_CP cp;
...
/* AVDT_SYNC_TO_BTC_LITE_REQ and AVDT_SYNC_TO_BTC_LITE_RESP */
typedef struct
{
    UINT16 lcid;
    UINT32 ssrc;
