...
typedef struct
{
    ...
    unsigned long acl_rx_completed_error;
    ...
    unsigned long diag_rx_completed_error;
    ...
    unsigned long event_completed_error;
    ...
    /* Number of bad voice RX frames received */
    ...
    /* Voice packet whose size exceeded limit */
