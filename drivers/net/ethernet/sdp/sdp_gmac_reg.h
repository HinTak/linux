...
typedef struct {
	...
	volatile u32 rxInterruptWatchdogCnt;	/* 0x1024 */
	volatile u32 axiBusMode;	/* 0x1028 */
	volatile u32 masterBusStatus;	/* 0x102C */
	volatile u32 reserved0[6];		/* 0x1030 ~ 0x1044 */
...
//AXI bus mode 0x1028
#define B_AXI_BLEN4			(1UL << 1)
#define B_AXI_BLEN8			(1UL << 2)
#define B_AXI_BLEN16		(1UL << 3)
#define B_AXI_BLEN32		(1UL << 4)
#define B_AXI_BLEN64		(1UL << 5)
#define B_AXI_BLEN128		(1UL << 6)
#define B_AXI_BLEN256		(1UL << 7)
#define B_AXI_1KBBE			(1UL << 13)
#define B_AXI_RD_OSR_LMT(val)	((val&0xF)<<16)
#define B_AXI_RD_OSR_LMT_MASK	(0xF<<16)
#define B_AXI_WR_OSR_LMT(val)	((val&0xF)<<20)
#define B_AXI_WR_OSR_LMT_MASK	(0xF<<20)
#define B_AXI_LPI_XIT_FRM	(1UL << 30)
#define B_AXI_EN_LPI		(1UL << 31)
...
#define NUM_TX_DESC		((PAGE_SIZE*16)/sizeof(DMA_DESC_T))
#define NUM_RX_DESC		((PAGE_SIZE*16)/sizeof(DMA_DESC_T))
...
typedef struct {
	...
	phys_addr_t sw_buffer1;
	phys_addr_t sw_buffer2;
...
#define CONVERT_DMA_QPTR(dmaDesc, Length, Buffer1, Data1, Buffer2, Data2) { \
	...
	dmaDesc.sw_buffer1 = (phys_addr_t)Buffer1; \
	dmaDesc.data1 = (void *)Data1; \
	dmaDesc.sw_buffer2 = (phys_addr_t)Buffer2; \
	dmaDesc.data2 = (void *)Data2; \
}
