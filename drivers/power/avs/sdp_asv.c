...
#elif defined(CONFIG_SDP1202_AVS)
#include "sdp1202_asv.c"
#elif defined(CONFIG_SDP1501_AVS)
#include "sdp1501_asv.c"
#else
...
#elif defined(CONFIG_SDP1202_AVS)
	ret = sdp1202_asv_init(asv_info);
#elif defined(CONFIG_SDP1501_AVS)
	ret = sdp1501_asv_init(asv_info);
#else
	ret = -EIO;
#endif
	if (ret) {
