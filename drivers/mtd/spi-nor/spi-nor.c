...
#define SPI_NOR_HAS_TB          0x200	/*
					 * Flash SR has Top/Bottom (TB) protect
					 * bit. Must be used with
					 * SPI_NOR_HAS_LOCK.
					 */
#define SPI_NOR_HAS_BP3		0x400	/* use 4 block protect bit (bp0-3) */
};
...
static int write_sr_and_check(struct spi_nor *nor, u8 status_new, u8 mask)
{
	...
	dev_info(dev, "status register = 0x%x\n", ret);
 ...
 *    0   |   0   |   1   |   0   |   0   |  512 KB       | Upper 1/128
 *    0   |   0   |   1   |   0   |   1   |   1 MB        | Upper 1/64
 *    0   |   0   |   1   |   1   |   0   |   2 MB        | Upper 1/32
 *    0   |   0   |   1   |   1   |   1   |   4 MB        | Upper 1/16
 *    0   |   1   |   0   |   0   |   0   |   8 MB        | Upper 1/8
 ...
 *    1   |   0   |   1   |   0   |   0   |  512 KB       | Lower 1/128
 *    1   |   0   |   1   |   0   |   1   |   1 MB        | Lower 1/64
 *    1   |   0   |   1   |   1   |   0   |   2 MB        | Lower 1/32
 *    1   |   0   |   1   |   1   |   1   |   4 MB        | Lower 1/16
 *    1   |   1   |   0   |   0   |   0   |   8 MB        | Lower 1/8
...
static const struct spi_device_id spi_nor_ids[] = {
	...
	{ "en25qh16b",	INFO(0x1c7015, 0, 64 * 1024,   32, SECT_4K) },
	...
	/* alias with w25q16 */
	{ "s25fl016k",  INFO(0xef4015,      0,  64 * 1024,  32, SECT_4K | SPI_NOR_HAS_LOCK) },
	/* alias with w25q64 : trick to detect w25q64 */
	{ "s25fl064k",  INFO(0x0,      0,  64 * 1024, 128, SECT_4K) },
	...
	/* alias with s25fl064k */
	{ "w25q64", INFO(0xef4017, 0, 64 * 1024, 128, SECT_4K) },
	{ "w25q64dw", INFO(0xef6017, 0, 64 * 1024, 128, SECT_4K) },
	{ "w25q80", INFO(0xef5014, 0, 64 * 1024,  16, SECT_4K) },
	/* alias with s25fl008k */
	{ "w25q80bl", INFO(0xef4014, 0, 64 * 1024,  16, SECT_4K) },
	{ "w25q128", INFO(0xef4018, 0, 64 * 1024, 256, SECT_4K | SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB) },
