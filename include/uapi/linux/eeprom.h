...
#define EEPROM_SET_WRITE_COUNT		_IOW(EEPROM_MAGIC, 0x07, unsigned int *)
#define EEPROM_GET_WRITE_COUNT		_IOR(EEPROM_MAGIC, 0x08, unsigned int *)
#define	EEPROM_SLAVE_ADDR		0x50
#define	EEPROM_MAX_CMDS			8
