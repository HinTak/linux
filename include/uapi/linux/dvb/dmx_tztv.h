...
#define DMX_CLEARALL_SECTION_FILTERS	_IO('o', 65)	/* clear all section filters for MBC,SBS,EBS1 novideo market issue */
...
#define SDP_START_SW_DRM 		 _IO('o', 110) /* Start SW DRM(ex Software Proidiom)*/ 
#define SDP_STOP_SW_DRM			 _IO('o', 111) /* Stop SW DRM(ex Software Proidiom)*/
