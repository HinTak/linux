...
#define FE_DBG_CMD_GET_SUPPORT_AUTO_T2		(0x0302) /* Auto Store?úÏóê T?Ä T2???Ä??Auto DetectÍ∞Ä Í∞Ä?•ÌïúÏßÄ ?¨Î?. */
...
#define FE_DBG_CMD_GET_L1_VERSION			(0x0338) /* get l1 version */
#define FE_DBG_CMD_GET_L1_READY				(0x0339) /* get l1 ready status */
...
#define FE_DBG_CMD_GET_MODULATION			(0x0342) /* Get modulation type for DVBC */
#define FE_DBG_CMD_GET_SYMBOLRATE			(0x0343) /* Get symbolrate for DVBC */
#define FE_DBG_CMD_REGION_CHANGED			(0x0344) /* set localset has been changed(SELA) */
#define FE_DBG_CMD_ATSC30_TEST_PATTERN		(0x0345) /* set value for atsc3.0 test pattern 0~3 */
#define FE_DBG_CMD_ANTENNA_TYPE				(0x0346) /* set Antenna type Air/Cable/Satellite */
#define FE_DBG_CMD_SET_VIDEOPLP_LIST		(0x0347) /* set video plp list */
#define FE_DBG_CMD_GET_CURRENTPLP_LIST		(0x0348) /* get current plp list */
#define FE_DBG_CMD_GET_SUBTUNER_USED		(0x0349) /* for KPI log : slave tuner use flag */
#define FE_DBG_CMD_SET_SUSPEND				(0x350)	/* for tuner suspend */
#define FE_DBG_CMD_SET_RESUME				(0x351)	/* for tuner resume */


#define FE_DBG_CMD_GET_I2C_RESULT			(0x0999) /* test i2c for EW */	
#define FE_DBG_CMD_GET_AUTO_REACQ			(0x0998) /* test auto reacq cnt for EW */
