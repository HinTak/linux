...
enum sdp_chipid {
	...
	SDP_NIKEM_CHIPID,/*Nike-M*/
	SDP_NIKEL_CHIPID,/*Nike-L*/
	MAX_SDP_CHIPID
};
...
IS_SDP_SOC(nikem, SDP_NIKEM_CHIPID)/*Nike-M*/
IS_SDP_SOC(nikel, SDP_NIKEL_CHIPID)/*Nike-L*/
...
static inline int soc_is_nike(void)
{
	return is_nikem() || is_nikel();
}
...
#define soc_is_nikem()	is_nikem()
#define soc_is_nikel()	is_nikel()
