...
#define SDP_TMU_UPDATE_TEMP     0x0005
...
extern int sdp1202_tmu_init(struct sdp_tmu_info *info);
...
extern int sdp1412_tmu_init(struct sdp_tmu_info *info);
extern int sdp1501_tmu_init(struct sdp_tmu_info *info);
