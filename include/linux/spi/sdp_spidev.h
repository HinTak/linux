...
#define SPI_IOC_RD_FRAME_FORMAT		_IOR(SPI_IOC_MAGIC, 6, __u32)
#define SPI_IOC_WR_FRAME_FORMAT		_IOW(SPI_IOC_MAGIC, 6, __u32)
...
#define SPI_IOC_WR_WHOLE_CONFIG		_IOW(SPI_IOC_MAGIC, 7, __u32)
