...
/**
****************************************************************************************************
 * @brief filtering namespace for SecureContainer
 * @return if block, return not zero
****************************************************************************************************
 **/
...
static inline int sf_security_create_new_namespaces(unsigned long flags,
	struct task_struct *tsk, struct user_namespace *user_ns,
	struct fs_struct *new_fs)
{
	return 0;
...
static inline int sf_process_authorized(struct task_struct *cur, struct task_struct *tsk)
{
    return 1;
}
