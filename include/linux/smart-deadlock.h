...
enum smart_deadlock_profile_type {
	...
	SMART_DEADLOCK_PROFILE_KERN_RWSEM,
};
...
struct smart_deadlock_kern_rwsem {
...
struct smart_deadlock_service {
	...
	unsigned long int last_exec_start;
...
struct smart_deadlock_meminfo {
	...
	unsigned long cma_used_less_fallback;
#endif
};
