...
#endif
#define SAMSUNG_HOST_USBNET_HYPERUART
#define SAMSUNG_USBNET_HYPERUART_PREALLOC
...
#define CAS_DONGLE_CNC_KERNEL_LEVEL_SUPPORT	// Patch to support C & C framework for NAGRA CAS Dongle
