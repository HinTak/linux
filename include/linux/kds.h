...
#define KDS_FLAG_LOCKED_IGNORE  (1u <<  0) /* don't wait, but block otherthat waits */
#define KDS_FLAG_LOCKED_WAIT    (2u <<  0) /* wait (normal */
#define KDS_FLAG_LOCKED_ACTION  (3u <<  0) /* mask to extract the action todo on locked resources */
