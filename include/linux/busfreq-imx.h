...
struct busfreq_api {
	void (*request)(enum bus_freq_mode mode);
	void (*release)(enum bus_freq_mode mode);
	int (*get_mode)(void);
};

#ifdef CONFIG_CPU_FREQ
extern struct busfreq_api busfreq_callback;
extern unsigned int imx8_get_soc_revision(void);
