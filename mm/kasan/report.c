...
struct trace_hash {
	...
	unsigned long entries_alloc[MAX_TRACE];
	unsigned long entries_free[MAX_TRACE];
	unsigned long entries_access[MAX_TRACE];
	size_t access_size;
};
...
static int kasan_save_kernel_stack(struct kasan_access_info *info, int skip)
{
	...
	unsigned long stack_trace[MAX_TRACE], stack_trace_alloc[MAX_TRACE],
		      stack_trace_free[MAX_TRACE];
