...
/**
****************************************************************************************************
* @brief Add mount information or uep-verifying result by using OperationInterface
* @param[in] nAddType               Indicate whether handle mount information or uep-verifying result
* @param[in] pOperationInterface
* @param[in] pMntType               Mount type information
* @param[in] nMnfFlag               Mount flag
* @param[in] pArrResult             uep-verifying result array
* @param[in] ArrSize                the size of pArrResult array
* @return void  
****************************************************************************************************
*/
