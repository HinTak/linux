...
#define SFD_UEP_LEVEL_CONTAINER_API     '5'
#define SFD_UEP_LEVEL_CONTAINER_PROC      '7'
#define SFD_UEP_LEVEL_CONTAINER_SYSCALL '8'
#define SFD_UEP_LEVEL_CONTAINER_PATH      '9'
#define SFD_UEP_LEVEL_CONTAINER_DEBUG      'D'
#define SFD_UEP_LEVEL_CONTAINER_SECURE      'F'

#define  SFD_UEP_LEVEL_CONTAINER      SFD_UEP_LEVEL_CONTAINER_API

#define SFD_UEP_INIT_VERSION		'3'
/**
****************************************************************************************************
