...
#define UEP_DEC_SIG_LEN 4
    ...
    do
    {
        ...
        */
        ...
        if ( pInfo->signatureLength <= 0 || pInfo->signatureLength >= 2*KB_SIZE )
        {
            SF_LOG_E("[%s] invalid signatureLength = %d ", __FUNCTION__, pInfo->signatureLength);
            result = SF_STATUS_UEP_SIGNATURE_INCORRECT;
            break;
        }
        ...
        */
        ...
        {
            SF_LOG_E("[%s] sf_malloc failed ", __FUNCTION__);
            result = SF_STATUS_NOT_ENOUGH_RESOURCE;
            break;
        }
