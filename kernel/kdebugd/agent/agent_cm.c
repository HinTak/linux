...
static struct agent_cm_status g_agent_cm_status = {CM_STOP, CM_STOP, CM_STOP, CM_STOP, CM_STOP,
						CM_STOP, CM_STOP, CM_STOP, CM_STOP, CM_STOP, CM_STOP};
...
enum agent_cm agent_open_fd_get_status(void)
{
	return g_agent_cm_status.open_fd;
}
...
void agent_thread_profiler_set_status(enum agent_cm status)
{
	g_agent_cm_status.thread_profiler = status;
}

enum agent_cm agent_thread_profiler_get_status(void)
{
	return g_agent_cm_status.thread_profiler;
}
...
void agent_open_fd_set_status(enum agent_cm status)
{
	g_agent_cm_status.open_fd = status;
}
...
/* COUNTER MONITOR PSS memory usage function */
enum agent_cm agent_pss_mem_get_status(void)
{
	return g_agent_cm_status.pss;
}

void agent_pss_mem_set_status(enum agent_cm status)
{
	g_agent_cm_status.pss = status;
}

/* COUNTER MONITOR Stack usage function */
enum agent_cm agent_stackinfo_get_status(void)
{
	return g_agent_cm_status.stackinfo;
}

void agent_stackinfo_set_status(enum agent_cm status)
{
	g_agent_cm_status.stackinfo = status;
}
