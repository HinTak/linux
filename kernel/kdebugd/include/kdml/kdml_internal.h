...
extern int kdml_alloc_probe_memory(void);
...
extern void probe_vmalloc(void *ignore, void *addr, unsigned long real_size,
		gfp_t gfp_flags, const void *call_site,
		enum kdml_vmalloc_trace_type vmalloc_type);
extern void probe_vfree(void *ignore, unsigned long call_site, const void *ptr);
