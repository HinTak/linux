...
struct agent_cm_status {
	...
	enum agent_cm open_fd;
	enum agent_cm pss;
	enum agent_cm thread_profiler;
	enum agent_cm stackinfo;
};
...
/* AGENT CM: PSS mem usage get status */
enum agent_cm agent_pss_mem_get_status(void);

/* AGENT CM: PSS mem usage set status */
...
/* AGENT CM: open fd get status */
enum agent_cm agent_open_fd_get_status(void);

/* AGENT CM: Stackinfo get status */
