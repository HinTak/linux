...
/* extern variable */
struct tdebugd_queue t2ddebugd_queue;
unsigned int t2ddebugd_running;

/*
 * Debugd event queue management.
 */
static inline int queue_empty(struct tdebugd_queue *q)
{
	return q->event_head == q->event_tail;
}

static inline void queue_get_event(struct tdebugd_queue *q,
