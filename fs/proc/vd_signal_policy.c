...
/*
 * NOTE: task name in signal_allow_task_name
 * must not exceed 15 characters.
 */
#ifdef CONFIG_PROC_VD_SIGNAL_HANDLER_DEFAULT_TASK
        static const char * const signal_allow_task_name[] = {"valgrind", "memcheck-arm-li", "massif-arm-linu", \
                                                                        "lackey-arm-linu", "helgrind-arm-li", "drd-arm-linux", \
                                                                        "callgrind-arm-l", "cachegrind-arm-", "gplayer-runtime", "dotnet-launcher"
...
ssize_t vd_signal_policy_add(struct file *seq,
