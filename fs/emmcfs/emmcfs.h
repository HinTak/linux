...
#if LINUX_VERSION_CODE > KERNEL_VERSION(3, 9, 4)
	BUILD_BUG();
#endif
...
/** First file inode */
/** Xattr btree special file inode number */
#define VDFS_XATTR_TREE_INO			11

#define EMMCFS_1ST_FILE_INO			20
...
/* inode.c */
static inline void emmcfs_put_inode_into_dirty_list(struct inode *inode)
{
 ...
 * @brief	Expands file.
 */
int expand_file(struct inode *inode, sector_t iblock, sector_t *res_block);
...
#define EMMCFS_MOUNT_STRIPPED		0x00010000
